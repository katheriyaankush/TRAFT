export default class CommonConstants {
  ...
  static readonly WAIT = Number.parseInt(process.env.TEST_TIMEOUT, 10) * CommonConstants.ONE_THOUSAND * CommonConstants.SIXTY;
  static readonly API_TIMEOUT = Number.parseInt(process.env.API_WAIT_TIMEOUT, 10) * CommonConstants.ONE_THOUSAND * CommonConstants.SIXTY;
  static readonly DEFAULT_TIMEOUT = Number.parseInt(process.env.WAIT_TIMEOUT, 10) * CommonConstants.ONE_THOUSAND * CommonConstants.SIXTY;
}
